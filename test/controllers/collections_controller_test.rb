...
class CollectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collection" do
    assert_difference("Collection.count") do
      post collections_url, params: { collection: { name: @collection.name, status: @collection.status, user_id: @collection.user_id } }
    end
  ...
  test "should update collection" do
    patch collection_url(@collection), params: { collection: { name: @collection.name, status: @collection.status, user_id: @collection.user_id } }
